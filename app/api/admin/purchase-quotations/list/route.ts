...
export async function GET(req: Request) {
  ...
  try {
    ...
    let query = localAdminSupabase.from("PurchaseQuotation").select(`*,supplier:supplier_management_items(id, company_name, contact_person, email, phone),materials:purchasequotationmaterial(*,rawMaterial:RawMaterial(*))`);
